...
import static com.testrigor.selfhealingselenium.application.utils.HtmlConstants.DEFAULT_FONT_SIZE;
import static com.testrigor.selfhealingselenium.application.utils.HtmlConstants.VALUE_HIDDEN;
import static com.testrigor.selfhealingselenium.application.utils.HtmlConstants.VALUE_MINUS_ONE;
import static com.testrigor.selfhealingselenium.application.utils.HtmlConstants.VALUE_NONE;
...
public class NodeInformationDeserializer {
	...
	public static final NodeInformation NULL_INFO = NodeInformation.builder()
		...
		.isVisible(false)
		.display(VALUE_NONE)
		.visibility(VALUE_HIDDEN)
		.zIndex(VALUE_MINUS_ONE)
		.isOnScreen(false)
	...
	static int convertFontSizeToPixels(String fontSizeStrRaw) {
		...
		if (endsWithIgnoreCase(fontSizeStr, CSS_PX)) {
			...
			final int pxValue = toInt(pxSizeStr, DEFAULT_FONT_SIZE);
			return pxValue;
		}
		...
		if (endsWithIgnoreCase(fontSizeStr, CSS_EM)) {
			...
			final int pxValue = (int) round(DEFAULT_FONT_SIZE * emValue);
			return pxValue;
		}
